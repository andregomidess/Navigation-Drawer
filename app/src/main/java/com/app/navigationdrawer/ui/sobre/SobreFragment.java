package com.app.navigationdrawer.ui.sobre;
...
public class SobreFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String descricao = "A ATM Consultoria tem como missão apoiar organizações que desejam alcançar" +
                " o sucesso atráves da exceleência em gestão e da busca pela qualidade";
        ...
        return new AboutPage(getActivity())
                ...
                .addFacebook("andre.lucca.37", "Facebook")
                .addInstagram("andre.lucca.37", "Instagram")
                .addTwitter("andre.lucca.37", "Twitter")
                .addYoutube("andre.lucca.37", "YouTube")
                .addGitHub("andregomidess", "GitHub")
                .addItem(versao)
